...
async function processImage(inputPath, outputPath) {
  try {
    ...
    console.log(
      `Successfully processed ${inputPath} and saved to ${outputPath}`,
    );
  } catch (e) {
...
async function run() {
  await processImage(
    "assets/parallax_mg.png",
    "assets/parallax_mg_adjusted.png",
  );
  await processImage(
    "assets/parallax_fg.png",
    "assets/parallax_fg_adjusted.png",
  );
}
