...
const particleColor = style.getPropertyValue('--particle-color').trim() || 'rgba(0, 0, 0, 0.5)';
const lineColor = style.getPropertyValue('--particle-line-color').trim() || 'rgba(0, 0, 0, 0.15)';
